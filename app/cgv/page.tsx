        ...
        <div className="space-y-8 text-[var(--color-text-secondary)] leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc list-inside mt-2 space-y-1">
              <li>Audit et stratégie IA pour entreprises</li>
              ...
              <li>Création de contenu marketing assistée par IA</li>
              <li>Production vidéo et montage</li>
            </ul>
          </section>

          <section>
            <h2 className="font-serif text-xl text-[var(--color-text-primary)] mb-3">3. Tarifs et paiement</h2>
            <p>
              Les tarifs sont indiqués en euros (EUR) et sont susceptibles de modification. Un devis détaillé est fourni avant toute prestation. Le paiement s&apos;effectue selon les modalités convenues dans le devis :
            </p>
            <ul className="list-disc list-inside mt-2 space-y-1">
              <li>Acompte de 30% à la signature du devis</li>
              <li>Solde à la livraison du projet</li>
              <li>Paiement par virement bancaire (Wise, AirWallex) ou Stripe</li>
            </ul>
          </section>

          <section>
            <h2 className="font-serif text-xl text-[var(--color-text-primary)] mb-3">4. Délais de réalisation</h2>
            <p>
          ...
          <section>
            <h2 className="font-serif text-xl text-[var(--color-text-primary)] mb-3">5. Propriété intellectuelle</h2>
            <p>
          ...
          <section>
            <h2 className="font-serif text-xl text-[var(--color-text-primary)] mb-3">6. Résiliation</h2>
            <p>
          ...
          <section>
            <h2 className="font-serif text-xl text-[var(--color-text-primary)] mb-3">7. Responsabilité</h2>
            <p>
          ...
          <section>
            <h2 className="font-serif text-xl text-[var(--color-text-primary)] mb-3">8. Droit applicable</h2>
            <p>
